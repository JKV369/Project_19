...
function createCash() {
  ...
  cash.scale=0.12;
  cash.velocityY = windowHeight/100;
  cash.lifetime = windowHeight/windowHeight/100 ;
  cashG.add(cash);
  }
}
...
function createDiamonds() {
  ...
  diamonds.scale=0.03;
  diamonds.velocityY = windowHeight/100;
  diamonds.lifetime = windowHeight/windowHeight/100;
...
function createJwellery() {
  ...
  jwellery.scale=0.13;
  jwellery.velocityY = windowHeight/100;
  jwellery.lifetime = windowHeight/windowHeight/100;
...
function createSword(){
  ...
  sword.scale=0.1;
  sword.velocityY = windowHeight/100;
  sword.lifetime = windowHeight/windowHeight/100;
